  ...
  return (
    <nav className={headerClass}>
      <ul>
        ...
        {isLoggedIn && (
            <>
              {isAdmin && ( // Dodanie warunku dla roli admina
                  <li><a href="addBook" className={activePage === 'addbook' ? 'active' : ''}><img src={AddBookImage} alt="Add Book"/>Add Book</a></li>
              )}
              <li><a href="profile" className={activePage === 'profile' ? 'active' : ''}><img src={ProfileImage}
